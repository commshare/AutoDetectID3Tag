...
void MainWindow::openFile()
{
	...
	*/
    ...
    //参考https://gitorious.org/mysocials/mysocials/commit/e32103d684b6128ddf6c23bcf1be624fb2493aa5
	loadMp3(QFileDialog::getOpenFileName(
				this, tr("Open MP3 Files"),
                /*QDesktopServices::storageLocation(QDesktopServices::MusicLocation)*/
                (QStandardPaths::standardLocations(QStandardPaths::DataLocation)).at(0),/*"MP3 Files (*.mp3)"*/"all files(*.*)", 0, 0));
}
...
void MainWindow::loadMp3(QString mp3FilePath)
{
  ...
  QByteArray ba = QFile::encodeName(mp3FilePath).constData();
    //c style ? I remove them 20150327
...
/*
 * QString::toAscii() and QString::fromAscii() are now deprecated, but should still be there
 *  (they are replaced by QString::fromLatin1() and QString::toLatin1()).
*/
//	std::cout << "reload encoding: " << text.toStdString() << std::endl;
    //readMp3Info(text.toAscii().data());
    readMp3Info(text.toLatin1().data());
}
